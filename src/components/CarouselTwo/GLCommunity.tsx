...
const GLCommunity: React.FC = () => {
  const [contacts, setContacts] = useState([
    { id: 1, name: 'Elizabeth', phoneNumber: '1234567890' },
    { id: 2, name: 'Shari', phoneNumber: '0987654321' },
    { id: 3, name: 'Pat', phoneNumber: '9876543210' },
    { id: 4, name: 'John', phoneNumber: '0123456789' },
    { id: 5, name: 'Matthew', phoneNumber: '6789012345' },
  ]);
